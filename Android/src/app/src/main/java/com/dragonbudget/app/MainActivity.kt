...
import com.dragonbudget.app.ui.AddPurchaseScreen
import com.dragonbudget.app.ui.AddPurchaseViewModel
import com.dragonbudget.app.ui.AskDragonScreen
import com.dragonbudget.app.ui.AskDragonViewModel
import com.dragonbudget.app.ui.HomeScreen
import com.dragonbudget.app.ui.HomeViewModel
import com.dragonbudget.app.ui.theme.DragonBudgetTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val container = (application as DragonBudgetApplication).container
        setContent {
            DragonBudgetTheme {
                Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
                    DragonBudgetApp(container)
                }
            }
        }
    }
...
@Composable
private fun DragonBudgetApp(container: AppContainer) {
